...
namespace OpenGameList.Data
{
    public class DbSeeder
    {
        ...
        public async Task SeedAsync()
        {
            ...
            //create default items if there are none
        ...
        {
            DateTime createdDate = new DateTime(2018, 19, 10, 12, 30, 00);
        ...
        private void CreateItems()
        {
           ...
           "Admin").FirstOrDefault().Id;
            ...
            EntityEntry<Item> e2 = DbContext.Items.Add(new Item()
            {
                ...
                Notes = "This is a sample record created by the Code-Fi Configuration class",
                ViewCount = 4180,
                CreatedDate = createdDate,
                LastModifiedDate = lastModifiedDate
            });
            EntityEntry<Item> e3 = DbContext.Items.Add(new Item()
            {
                ...
                Description = "A free game about shooting evil space ducks withtiny, cute guns.",
                ...
                Notes = "This is a sample record created by the Cod  Configuration class",
                ViewCount = 5203,
                CreatedDate = createdDate,
                LastModifiedDate = lastModifiedDate
            });
            EntityEntry<Item> e4 = DbContext.Items.Add(new Item()
            {
                ...
                Text = @"The game is currently under Milestone 3. The Milestone
                    ...
                    license.",
                Notes = "This is a sample record created by the CConfiguration class",
                ViewCount = 9602,
                CreatedDate = createdDate,
                LastModifiedDate = lastModifiedDate
            });
       ...
       DateTime createdDate)
        {
            return new Item()
            {
                ...
                Description = String.Format("This is a sample description fo item { 0 }: Lorem ipsum dolor sit amet.", id),
                Notes = "This is a sample record created by the Code-Fir Configuration class",
                ViewCount = viewCount,
                CreatedDate = createdDate,
